...
{name:"Fiber Glass Overlay",defaultImg:carriageSteel,id:"Steel Overlay",defaultDesign:"11",defaultColor:"Bronze with Black",rwd:"CHI_OverlayCarriageHouse.rwd",
 style:"Steel Overlay",
 colors:{White:"#EAEEED","Sandstone":"#9E9188",Almond:"#D5CBBF",Bronze:"#6E6D69", Black:"#000000ff",
        "Bronze with Black":"#6E6D69,#000000ff","White with Black":"#EAEEED,#000000ff","Almond with Black":"#D5CBBF,#000000ff", "Sandstone with Black":"#9E9188,#000000ff"},
 woods:null,
...
{name:"Wood Overlay",defaultImg:carriageSteel,id:"Steel Overlay",defaultDesign:"11",defaultColor:"Bronze with Black",rwd:"CHI_OverlayCarriageHouse.rwd",
 style:"Steel Overlay",
 colors:{White:"#EAEEED","Sandstone":"#9E9188",Almond:"#D5CBBF",Bronze:"#6E6D69", Black:"#000000ff",
        "Bronze with Black":"#6E6D69,#000000ff","White with Black":"#EAEEED,#000000ff","Almond with Black":"#D5CBBF,#000000ff", "Sandstone with Black":"#9E9188,#000000ff"},
 woods:null,
...
function SlideShow({ handleCarouselClick, doorsImgs, index,doorNavName,doorType}) {
  ...
  for (let i = 0; i < doorsImgs.length; i++) {
    doorElements.push(
      <div className={`carousel-item subtype-item ${i === 0 ? 'active' : ''}`} key={i}>
        <img loading="eager" onClick={() => handleCarouselClick(index,doorNavName)} src={doorsImgs[i]} className="img-fluid" />
      </div>
    );
  }
  return (
  ...
  <div id="centering-div">
    ...
    {Object.keys(doorImages).map((subType,index) =>{
      ...
      <div className="subtype-container" key={subType}>
        <h2>{subType}</h2>
        <SlideShow handleCarouselClick={handleCarouselClick} doorsImgs={doorImages[subType]} index={index} doorNavName={doorNavName}/>
