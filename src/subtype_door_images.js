...
const carriageImages = {
  desktop: {
    ...
    "Fiberglass Overlay": import.meta.glob("/src/assets/door_imgs/carousel/carriage/Desktop/2 - Fiberglass Overlay Carriage House/*.jpg"),
  ...
  mobile: {
    ...
    "Fiberglass Overlay": import.meta.glob("/src/assets/door_imgs/carousel/carriage/Mobile/2 - Fiberglass Overlay Carriage House/*.jpg"),
